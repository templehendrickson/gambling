## this is just all the individual scripts from deuces in a single .py library
...
class Card (object):
    ...
    def formatCard(card_int):
        ...
        inv_map = {v: k for k, v in CHAR_SUIT_TO_INT_SUIT.items()}
        ...
        # get the actual values of each
        suit = inv_map[suit_int]
        face = STR_RANKS[rank_int]
